    ...
    mifosX.controllers = _.extend(module, {
        ViewClientController: function (scope, routeParams, route, location, resourceFactory, http, $modal, API_VERSION, $rootScope, $upload,dateFilter) {
            ...
            scope.getURL = function(id){
            	return $rootScope.hostUrl + API_VERSION + '/cliententitydetails/' + id + '/attachment?tenantIdentifier=default';
            };
            scope.getClientEntityDetails = function(){
        	   
        	   resourceFactory.clientEntityDetails.get({clientId: routeParams.id},function(data){
        		   scope.clientdocuments = data;
        	   });
            /*	scope.clientdocuments = [{
            		registeredName: "Syed Mujeeb Ur Rahman1",
            		tradingName: "Rahman Trading1",
            		dateOfIncorporation: dateFilter(new Date(),"dd MMMM yyyy")
            	},
            	{
            		registeredName: "Syed Mujeeb Ur Rahman2",
            		tradingName: "Rahman Trading2",
            		dateOfIncorporation: dateFilter(new Date(),"dd MMMM yyyy")
            	},
            	{
            		registeredName: "Syed Mujeeb Ur Rahman3",
            		tradingName: "Rahman Trading3",
            		dateOfIncorporation: dateFilter(new Date(),"dd MMMM yyyy")
            	}];*/
